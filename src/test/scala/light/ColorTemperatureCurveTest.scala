...
class ColorTemperatureCurveTest extends FlatSpec with ShouldMatchers {
  ...
  "Cold end" should "be correct" in {
    val (x, y) = ColorTemperatureCurve(20000)
