...
class ColorCurveTest extends FlatSpec with ShouldMatchers {
  ...
  "The given points" should "be correct" in {
    ...
    c.y(0.251) should be(0.251 plusOrMinus 0.001)
    c.y(0.315) should be(0.322 plusOrMinus 0.001)
  ...
  "The interpolated points" should "also be correct" in {
    val c = new ColorCurve()
    c.y(0.350) should be(0.358 plusOrMinus 0.005)
    c.y(0.584) should be(0.393 plusOrMinus 0.005)
  }
